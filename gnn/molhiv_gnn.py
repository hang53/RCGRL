...
class MolHivNet(torch.nn.Module):
    ...
    def __init__(self, num_tasks=2, num_layers = 3, emb_dim = 300, dropout = 0.5, encode_node = False):
        """
        Args:
        ...
        self.gnn_node = GINConv(emb_dim)

        # Pooling function to generate whole-graph embeddings
        self.pool = global_mean_pool
        self.robust_lin = torch.nn.Linear(self.emb_dim, self.num_tasks)
    ...
    def forward(self, x, edge_index, edge_attr, batch):
        ...
        return self.get_robust_pred(h_graph)
    ...
    def get_robust_pred(self, h_graph):
        return self.robust_lin(h_graph)
    ...
    def get_comb_pred(self, robust_graph_x, conf_graph_x):
        ...
        robust_pred = self.robust_lin(robust_graph_x)
